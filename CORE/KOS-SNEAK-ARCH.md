...
### 25.1 Authoritative Identity State
...
### 25.2 B2 — Request Interpretation and Routing
...
### 25.4 B4 — No Authority Invention
...
### 25.5 B5 — Derived Working Information
...
### 25.8 B8 — Deferral / Interface Boundary
...
### 25.9 B9 — Unknown and Ambiguous Conditions
...
### 25.13 B13 — Personality Boundary
...
## 26. Adopted Permission and Authority Boundary

KD-024 establishes the following permission and authority boundary for Sneak.

### 26.1 PA0 — Architectural Definitions
...
### 26.2 PA1 — Read / Action Separation
...
### 26.3 PA2 — Action Authorization Gate
...
### 26.4 PA3 — Grants Live with the Holder
...
### 26.5 PA4 — No Invention, No Escalation, No Social Authorization
...
### 26.6 PA5 — Deferral to the Applicable System
...
### 26.8 PA7 — Deny-by-Default Posture
...
### 26.9 PA8 — No Sneak-Level Access Judgments
...
### 26.10 PA9 — Derivation Neither Creates Authority Nor Expands Access
...
## 25. Adopted Permission Grant-Holder Designation Boundary
...
### 25.4 U — Undefined or Unresolvable Holder
...
## 26. Adopted Cross-System Authorization Boundary
...
### 26.2 T2-P2 — Three Roles per Effect
...
### 26.4 T2-P4 — No Sneak-Side Decomposition
...
### 26.5 T2-P5 — Multiplicity and Conjunction
...
### 26.6 T2-P6 — Failure Modes Fail Closed
...
### 26.7 T2-P7 — Legitimate Execution / Authorization Split
...
## 25. Explicitly Undefined / Not Established by KD-021 through KD-035

### Boundaries adopted; establishments pending

The following architectural boundaries are adopted through KD-035. Their enabling establishments — holders, declarers, rules, values, mechanics — remain undefined and proceed through later KDs, contracts, or owner decisions. Adoption of a boundary establishes none of its pending establishments.
...
### 26.2 T3-P2 — Cached Consultation in Authorization
...
### 26.3 T3-P3 — Invalidating Events
...
### 26.5 T3-P5 — Freshness Unestablishable
...
### 26.6 T3-P6 — Differential Stringency
...
### 26.7 T3-P7 — Authorization Freshness vs. Read-Data Caching
...
### 26.8 T3-P8 — Anti-Ledger Guarantees
...
### 26.3 T4-P3 — Direct and Multi-Source Derivation
...
### 26.4 T4-P4 — Attributable Transformation
...
### 26.5 T4-P5 — Source Failure Modes
...
### 26.6 T4-P6 — Authority Preservation
...
### 26.7 T4-P7 — Presentation Without Record-Creation
...
### 26.8 T4-P8 — Attribution Is Not Authorization
...
## 26. Adopted Standing-as-Permission-Input Boundary
...
### 26.2 T5-P2 — Standing May Be an Input; Sneak Does Not Perform the Inference
...
### 26.3 T5-P3 — The Permission Holder Remains Responsible
...
### 26.4 T5-P4 — Informational Eligibility Is Not Authorization
...
### 26.5 T5-R1 — Designated Standing Source
...
### 26.6 T5-R2 — Designated Permission Holder

The permission holder for the action must be designated under KD-025 D1.

### 26.7 T5-R3 — Established Standing-to-Permission Basis
...
### 26.9 T5-F1 — Fail-Closed Standing Conditions
...
### 26.14 Current Authorization Posture
...
## 25. Adopted Transcript Completion and Disposition Boundary
...
### 26.1 T6-P1 — No Silent Promotion
...
### 26.2 T6-P2 — Declaration Authority Is Established, Never Assumed
...
### 26.3 T6-P3 — Disposition Is a Status Transition, Not a Destination
...
### 26.4 T6-P4 — Effective Disposition Requires a Designated Holder
...
### 26.5 T6-P5 — Faithful Transition
...
### 26.6 T6-P6 — 1e and 3i Remain Distinct
...
### 26.7 T6-R1 — Completion-Declaration Authority
...
### 26.8 T6-R2 — Designated Transcript Holder
...
### 26.11 T6-F2 — No Designated Holder
...
## 26. Adopted Intake Holding, Routing, and Undeliverable-Content Boundary
...
### 26.1 T7-P1 — Interaction-Scoped Intake Buffers
...
### 26.2 T7-P2 — Unvetted by Default
...
### 26.3 T7-P3 — Holding Bounded Within the Interaction
...
### 26.4 T7-P4 — Narrow Structural Crossing
...
### 26.5 T7-P5 — Undeliverable Content
...
### 26.6 T7-P6 — Routing Failure Does Not Reclassify or Authorize
...
### 26.7 T7-P7 — No Cross-Interaction Persistence Without a Holder
...
## 25. Adopted Kustomz-to-Discord Identity-Linking Boundary

KD-032 establishes the following architectural boundary for Kustomz-to-Discord identity linking.

### 25.1 IL-D — Distinct Identities and Mapping
...
### 25.3 IL-L — Link-State Lifecycle
...
### 25.4 IL-S — State Classification
...
### 25.5 IL-C — Identity Is Not Permission
...
### 25.6 IL-F — Freshness Interaction
...
### 25.7 IL-A — Attribution Interaction
...
### 25.8 IL-X — Cross-Interface Identity Continuity
...
### 25.10 IL-E — Explicit Exclusions
...
### 26.4 RL-B — Boundary Interaction
...
### 26.6 RL-T — Read / Authorization Separation
...
### 26.7 RL-S — Transient Resolution State
...
### 26.8 RL-X — Cross-System Boundary
...
### 26.9 RL Dependencies and Undefined Prerequisites
...
### 26.10 RL Boundary and Circularity Check
...
## 25. Adopted Identity-Link Resolution Access / Query Basis Boundary
...
### 25.1 QB-P — Decision-Derived Query Interest
...
### 25.2 QB-Q — Preconditions for Legitimate Query
...
### 25.3 QB-R — Query Routed Through Authorization Boundary
...
### 25.4 QB-I — Addressing Identity Input
...
### 25.5 QB-F — Query Failure Handling
...
### 25.6 QB-S — Transient Query State
...
### 25.7 QB-X — Cross-System Boundary
...
### 25.8 QB Dependencies and Undefined Prerequisites
...
### 25.9 QB Boundary and Authority-Leak Check
...
### 26.3 LC-S — Lifecycle Status Vocabulary
...
### 26.4 LC-R — Status, Edge, Resolution, and Usage Distinction
...
### 26.5 LC-F — Lifecycle Invalidation
...
### 26.6 LC-M — Mid-Interaction Lifecycle Change
...
### 26.7 LC-U — Unknown and Failure Conditions
...
### 26.8 LC-A — Authoritative Lifecycle Source
...
### 26.9 LC-P — State Classification and Persistence Boundary
...
### 26.10 LC Dependencies and Undefined Procedures
...
### 26.11 LC Boundary and Authority-Leak Check
...
## 25. Known Architectural Tensions

### 25.1 Derived Statistics
...
### 25.2 Cross-Interface Continuity
...
### 25.3 Permission Grant-Holder Designation
...
### 25.4 Cross-System Authorization
...
### 25.6 Derived-Information Attribution
...
### 25.7 Standing as Permission Input
...
### 25.8 Intake Disposition Without an Established Path
...
## 26. Implementation-Owned Mechanics
